...
// SQL-Abfrage, um die neuesten Einträge mit den 10 meisten Likes abzurufen
$sql = "SELECT * FROM entries ORDER BY likes DESC, created_at DESC LIMIT 10";
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        if (strpos($row['entry_text'], '#') !== false) {
            ...
            // Ersetze die Keywords durch Links zu schächner.de
